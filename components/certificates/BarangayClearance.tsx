...
export default function BarangayClearance({ data }: Props) {
    ...
    return (
        <div style={{ ...bodyStyle, lineHeight: '1.6', fontFamily: 'Calibri, sans-serif' }}>
            {/* Document Title */}
            <CertTitle>BARANGAY CLEARANCE</CertTitle>
            ...
            <p style={{ textIndent: '40px', marginBottom: '16px', textAlign: 'justify' }}>
                <strong>THIS IS TO CERTIFY</strong> that <strong>{upperName}</strong>, {age} years old, {civilStatus}, born on {birthDate}, is a bona fide resident of this barangay with postal address at <strong>{address}</strong>, and is known to me as a person of good moral character and a law-abiding citizen of the community.
            </p>
            ...
            {/* Paragraph 3: Purpose */}
            <p style={{ marginBottom: '16px', textAlign: 'justify' }}>
                This clearance is issued upon the request of <strong>{upperName}</strong> for <strong>{(data.purpose || 'RECORD PURPOSES').toUpperCase()}</strong> and for whatever <strong><span style={{ borderBottom: '1px solid #000', paddingBottom: '1px' }}>LEGAL INTENT</span></strong> it may serve.
            </p>
