...
export default function CertificateOfResidency({ data }: Props) {
    ...
    return (
        <div style={{ ...bodyStyle, lineHeight: '1.6', fontFamily: 'Calibri, sans-serif' }}>
            {/* Document Title */}
            <CertTitle>CERTIFICATE OF RESIDENCY</CertTitle>
            ...
            <p style={{ textIndent: '40px', marginBottom: '16px', textAlign: 'justify' }}>
                <strong>THIS IS TO CERTIFY</strong> that <strong>{upperName}</strong>, {age} years old, {civilStatus}, born on {birthDate}, is a bona fide resident of this barangay since <strong>{residentSince}</strong> up to present with postal address at <strong>{address}</strong>.
            </p>
